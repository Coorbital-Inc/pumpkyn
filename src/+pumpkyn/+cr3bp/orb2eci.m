function [r, v] = orb2eci(mu, oev, dim3)
...
[oev,fSeq] = pumpkyn.util.fDim(oev,dim3);
         r = zeros(3, size(oev,1));
         v = zeros(3, size(oev,1));
...
if ~legacySetting
     r = r';
     v = v';
 [r,v] = pumpkyn.util.sDim(pumpkyn.util.eDim([r,v],fSeq),dim3);
end

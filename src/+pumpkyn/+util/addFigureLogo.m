...
% Its size and upper-left margins are converted to pixels and remain fixed
...
if nargin == 0
    ...
    logoFile = 'logo.png';
    logoPosition = [-0.004 0.92 0.13 0.11];
...
if ~isfile(logoFile)
    logoFile = fullfile( ...
        fileparts(mfilename('fullpath')),logoFile);
end
...
geometry(3:4) = max(1,geometry(3:4));

...
%  1. Generate a family of tulip-shaped periodic orbits in the Earth–Moon CR3BP
%  2. Compute and visualize key dynamical properties for each orbit
%  3. Understand how these properties evolve with orbital period
%
% Tulip-shaped orbits are resonant three-body trajectories characterized
% by repeating petal-like patterns around the Moon. Each family is defined
% by its number of petals (Np) and hemisphere (pm), representing distinct
% energy and symmetry configurations.
...
% Shows how long it takes for small perturbations to double in magnitude.
% Longer doubling times generally indicate greater orbital stability.
figure('Color',[1 1 1]);
...
% The stability index measures how sensitive an orbit is to perturbations.
% Values near 1 imply neutral stability, while larger values indicate
...
% Visualizes how the minimum and maximum lunar altitudes change as a
% function of orbital period. This helps identify orbits with practical
% altitudes for communications or observation missions.
figure('Color',[1 1 1]);
...
% The Jacobi constant represents the total energy of each orbit in the
% rotating frame. It provides insight into the energy distribution and
% dynamical accessibility of each family member.
figure('Color',[1 1 1]);
...
% Displays how long each orbit spends behind the Moon relative to Earth,
% representing communications blackout duration. Shorter occultations are
% preferred for continuous Earth visibility.
figure('Color',[1 1 1]);

...
This initial guess is solver\-sensitive. The vector contains costates for state variables + the unknown final time. Replace with your own if you have a better guess.

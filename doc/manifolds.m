...
%
% This tutorial demonstrates how to compute and visualize the **invariant manifolds**
% associated with a tulip-shaped orbit in the Earth–Moon CR3BP.
%
% Invariant manifolds represent natural dynamical pathways:
%   • The **stable manifold** guides trajectories that asymptotically approach the orbit.
%   • The **unstable manifold** describes paths that naturally depart from it.
%
% These structures are central to low-energy transfer design, lunar capture,
% and disposal trajectory studies. Manifolds also provide insight into 
% orbit stability and long-term dynamical behavior.
%
% Here, we focus on the **unstable manifold**, which emerges from small 
% perturbations along the orbit's unstable eigenvectors.
% Note: orbits with a stability index close to 1 may not generate 
% usable (distinct) manifolds.
...
%% Interpretation:
% The white trajectories are the unstable manifolds—natural escape paths.
% Each originates from a slightly perturbed state along the tulip orbit.
% Their geometry reveals low-energy transfer routes and long-term 
% dynamical structure within the cislunar region.
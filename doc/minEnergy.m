...
%
% This demonstration shows how to use Pumpkyn's CR3BP routines to estimate
% the minimum energy (ΔV) required for a spacecraft in a tulip-shaped orbit 
% to reach the lunar surface—or equivalently, the energy required for ascent 
% from the surface to that orbit.
%
% The method evaluates instantaneous transfer opportunities between points 
% along a periodic orbit and a grid of surface locations, then determines 
% the minimum achievable ΔV across the entire surface.
...
%
% This provides the full periodic trajectory in the rotating frame, 
% which serves as the reference path for computing transfer opportunities.
...
%% Interpretation:
% Color shading indicates the minimum ΔV required to reach each surface point.
% Low ΔV regions correspond to natural low-energy access zones.
% Comparing different orbits (NRHO vs. Tulip) highlights how orbital 
% energy and geometry influence feasible landing or ascent corridors.